...
exports.handler = async ( argv ) => {
    ...
    await terminal.install( {
        ...
        event:    operator.getRepo( 'https://github.com/liutingxie/wordpress-webpack-workflow.git', projectPath ),
    } );
    ...
    log.message( '' );
    log.message( `Please read the documentation ${ log.variable( 'https://github.com/liutingxie/wordpress-webpack-workflow' ) } if you run into any issues or if you have any questions.` );
    log.message( '' );
